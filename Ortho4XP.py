...
def build_dsf(lat0, lon0, ortho_list, water_overlay,
    ...
    for i in range(0, nbr_tri_in):
        ...
        if (tri_type == '0'):
            ...
            if len(texture) < 4:
                texture_overlay_idx = -1
            elif ((tri_type == '1' and use_masks_for_inland == False) or (
                ...
                if str(texture) + '_sea_overlay' in dico_textures:
                    ...
                    if mask_data != 'None':
                        ...
                        if os.path.isfile(build_dir + dir_sep + 'textures' + dir_sep + mask_name) != True:
        ...
        if tri_type == '0':
            ...
            if water_overlay == False:
                continue
            if texture_overlay_idx != -1 and (
                (tri_type == '1' and use_masks_for_inland == False) or int(texture[2]) < 14):
                tri_p = []
                for n in [n1, n3, n2]:  # beware of ordering for orientation !
